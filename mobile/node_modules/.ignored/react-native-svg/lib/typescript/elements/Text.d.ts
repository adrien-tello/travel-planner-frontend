...
import type { ColumnMajorTransformMatrix, NumberArray, NumberProp, TextSpecificProps } from 'react-native-svg/src/lib/extract/types';
import Shape from 'react-native-svg/src/elements/Shape';
import 'react-native-svg/src/elements/TSpan';
